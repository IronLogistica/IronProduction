...
LAUNCHPAD_GRUPPI = [
    ...
    {'nome': 'Pianificazione & KPI', 'icona': '📈', 'colore': '#2589c7', 'voci': [
        ...
        {'label': 'Lead Time Rifornimento', 'icona': '⏱️', 'url': '/alert-scorte'},
...
def create_app():
    ...
    with app.app_context():
        ...
        assicura_finiti_is_wms()
        assicura_quantita_verificata_ddt()
        assicura_verifica_ingresso_merci()
        ...
        assicura_mappa_mw_bersagli_multipli()
